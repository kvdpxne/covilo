const notFound = () => (
  <main
    ...
    <div className="text-center">
      ...
      <h1
        className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Page
        not found</h1>
      <p className="mt-6 text-base leading-7 text-gray-600">Sorry, we couldn’t
      ...
      <div className="mt-10 flex items-center justify-center gap-x-6">
        <a href="#"
          ...
          back home</a>
        <a href="#" className="text-sm font-semibold text-gray-900">Contact
